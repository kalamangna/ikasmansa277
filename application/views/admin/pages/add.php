...
<?php echo form_open('admin/add_page'); ?>
...
<p>
    ...
    <input type="text" name="slug" value="<?php echo set_value('slug'); ?>" required>
    <br><small>Slug digunakan untuk URL, misal: about, contact</small>
</p>
 -->
<p>
    <label for="content">Content</label><br>
    <textarea name="content" id="content" rows="10" cols="80"><?php echo set_value('content', isset($page['content']) ? $page['content'] : ''); ?></textarea>
