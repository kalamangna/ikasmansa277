  ...
  <div class="col-md-9 col-lg-7">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form method="post" action="<?php echo site_url('alumni/save?ut=' . $this->input->get('ut')); ?>" enctype="multipart/form-data" class="needs-validation" id="registForm" novalidate>
          <h4>Data Pribadi</h4>
